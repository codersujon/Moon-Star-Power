        ...
        <div class="row mb-5">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                <div class="single-project-image-box wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1200ms">
                    <img src="images/projects/6.jpg" alt="Moon Star PFI Panel Project 1" class="img-fluid rounded shadow w-100" style="height: 350px; object-fit: cover;">
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                <div class="single-project-image-box wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1200ms">
                    <img src="images/projects/PFI/PFI-1.jpeg" alt="Moon Star PFI Panel Project 2" class="img-fluid rounded shadow w-100" style="height: 350px; object-fit: cover;">
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="single-project-content-box">
                    ...
                    <div class="section-title text-center mb-5 wow fadeInDown" data-wow-delay="100ms">
                        <span class="text-primary font-weight-bold text-uppercase" style="letter-spacing: 1px;">Energy Efficiency & Power Quality</span>
                        <h2 class="mt-2 font-weight-bold text-dark">Automatic Power Factor Improvement (PFI) Panels</h2>
                    ...
                    <div class="content-block mb-5 wow fadeInUp" data-wow-delay="200ms">
                        <h3 class="font-weight-bold mb-3 text-dark">Understanding Power Factor & Sizing Calculation</h3>
                        ...
                        <div class="bg-light p-4 rounded border my-3 wow zoomIn" data-wow-delay="300ms">
                    ...
                    <div class="content-block mb-5 p-4 rounded bg-light border-left-primary wow zoomIn" data-wow-delay="200ms" style="border-left: 5px solid #0056b3;">
                        <h3 class="font-weight-bold mb-3 text-dark">World-Class Component Sourcing</h3>
                        <p class="mb-4 text-secondary">At <strong>Moon Star Power & Technology</strong>, we integrate tier-1 global hardware to prevent capacitor rupture, fire risks, and contactor welding:</p>
                    ...
                    <!-- Comparison Table -->
                    <div class="content-block mb-5 wow fadeInUp" data-wow-delay="200ms">
                        <h3 class="font-weight-bold mb-4 text-dark">Moon Star PFI Panel vs. Conventional Local Panels</h3>
                    ...
                    <div class="content-block mb-5">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <p class="wow fadeInUp text-secondary" data-wow-delay="200ms"><i class="fa fa-check text-primary mr-2"></i> <strong>Comprehensive Site Energy Audits:</strong> Data logger measurements to determine precise kVAR and harmonic levels.</p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <p class="wow fadeInUp text-secondary" data-wow-delay="300ms"><i class="fa fa-check text-primary mr-2"></i> <strong>Detuned Reactor Options:</strong> Custom detuned filter reactors added to safeguard against non-linear harmonic distortion.</p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <p class="wow fadeInUp text-secondary" data-wow-delay="400ms"><i class="fa fa-check text-primary mr-2"></i> <strong>Powder-Coated Enclosures:</strong> Heavy-gauge sheet metal cubicles designed for optimum heat dissipation and ventilation.</p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <p class="wow fadeInUp text-secondary" data-wow-delay="500ms"><i class="fa fa-check text-primary mr-2"></i> <strong>Lifetime Technical Support:</strong> Routine inspection, step testing, and after-sales service across Bangladesh.</p>
                            </div>
                        </div>
                    </div>
